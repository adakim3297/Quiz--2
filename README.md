...
Example
        ...
        int main(){
            ...
            printf("%d %d",u.a,u.b); --> a = 200, b = 200
...
* Union Example
        ...
        int main(){
            ...
            friend.type = 'P';
            strcpy(friend.un.person.first,"Seongmin");
            strcpy(friend.un.person.last,"Kim");
            ...
            for(int i= 0; i<2; i++){
                switch(name[i].type){
                    ...
                    case 'P';
                        printf("Friend: %s %c %s\n",names[i].un.person.first,un.person.init,un.person.last);
                        break;

                    default:
                        printf("Error in type\a\n");
                }
            } 
            return 0;
        }
